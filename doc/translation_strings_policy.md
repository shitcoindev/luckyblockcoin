...
This document provides guidelines for internationalization of the Luckyblockcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `luckyblockcoin_en.ts` remains unchanged.
