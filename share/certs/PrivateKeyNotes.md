...
unlocked to sign the Luckyblockcoin-Qt.app bundle.
...
allowing somebody to distribute a Luckyblockcoin-Qt.app or luckyblockcoin-qt-setup.exe with a valid
...
that the luckyblockcoin-qt.exe file inside the installer had not been tampered with.
