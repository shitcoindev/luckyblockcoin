...
from test_framework.util import (start_nodes, start_node, assert_equal, luckyblockcoind_processes)
...
class WalletDumpTest(LuckyblockcoinTestFramework):
    ...
    def run_test (self):
        ...
        luckyblockcoind_processes[0].wait()
