...
class RawTransactionsTest(LuckyblockcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid luckyblockcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid luckyblockcoin address" in e.error['message'])
