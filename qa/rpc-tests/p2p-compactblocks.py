...
# TestNode: A peer we use to send messages to luckyblockcoind, and store responses.
...
class CompactBlocksTest(LuckyblockcoinTestFramework):
    def __init__(self):
        super().__init__()
    ...
    # This test actually causes luckyblockcoind to (reasonably!) disconnect us, so do this last.
    ...
    # luckyblockcoind's choice of nonce.
    ...
    # Test that luckyblockcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for luckyblockcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # luckyblockcoind will not send blocktxn responses for blocks whose height is
