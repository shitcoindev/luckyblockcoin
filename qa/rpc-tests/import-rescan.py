...
import RPC call and node 0 sends LUB to it. Then other nodes import the
...
In the second part of the test, node 0 sends more LUB to each address, and the
...
class ImportRescanTest(LuckyblockcoinTestFramework):
    def __init__(self):
        super().__init__()
