...
#ifndef LUCKYBLOCKCOIN_QT_SENDCOINSDIALOG_H
#define LUCKYBLOCKCOIN_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending luckyblockcoins */
...
#endif // LUCKYBLOCKCOIN_QT_SENDCOINSDIALOG_H
