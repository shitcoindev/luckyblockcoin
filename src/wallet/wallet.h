...
#ifndef LUCKYBLOCKCOIN_WALLET_WALLET_H
#define LUCKYBLOCKCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this luckyblockcoin node, and set to 0 for transactions that were created
...
#endif // LUCKYBLOCKCOIN_WALLET_WALLET_H
