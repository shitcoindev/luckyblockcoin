 ...
 * between luckyblockcoind, and luckyblockcoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("luckyblockcoin-shutoff");
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-conf=<file>", strprintf(_("Specify configuration file (default: %s)"), LUCKYBLOCKCOIN_CONF_FILENAME));
    if (mode == HMM_LUCKYBLOCKCOIND)
    {
#if HAVE_DECL_DAEMON
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), LUCKYBLOCKCOIN_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/luckyblockcoin/luckyblockcoin>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("luckyblockcoin-loadblk");
...
/** Sanity checks
 *  Ensure that Luckyblockcoin is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Luckyblockcoin version %s\n", FormatFullVersion());
}
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Luckyblockcoin process is using the data directory.
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(GetArg("-conf", LUCKYBLOCKCOIN_CONF_FILENAME)).string());
