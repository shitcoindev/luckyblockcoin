...
#ifndef LUCKYBLOCKCOIN_TEST_SCRIPTNUM10_H
#define LUCKYBLOCKCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Luckyblockcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // LUCKYBLOCKCOIN_TEST_BIGNUM_H
