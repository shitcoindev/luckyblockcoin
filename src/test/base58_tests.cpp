...
BOOST_AUTO_TEST_CASE(base58_keys_valid_parse)
{
    ...
    for (unsigned int idx = 0; idx < tests.size(); idx++) {
        ...
        if(isPrivkey)
        {
            ...
            // Note: CLuckyblockcoinSecret::SetString tests isValid, whereas CLuckyblockcoinAddress does not!
...
BOOST_AUTO_TEST_CASE(base58_keys_valid_gen)
{
    ...
    for (unsigned int idx = 0; idx < tests.size(); idx++) {
        ...
        else
        {
            ...
            CLuckyblockcoinAddress addrOut;
    ...
    CLuckyblockcoinAddress dummyAddr;
