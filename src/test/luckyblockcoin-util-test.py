...
help_text="""Test framework for luckyblockcoin utils.

Runs automatically during `make check`.

Can also be run manually from the src directory by specifying the source directory:

test/luckyblockcoin-util-test.py --srcdir='srcdir' [--verbose]
"""
...
if __name__ == '__main__':
    ...
    bctest.bctester(srcdir + "/test/data", "luckyblockcoin-util-test.json", buildenv)
